...
using KinkLinkCommon.Dependencies.Moodles.Enums;
    ...
    SelectionManager selectionManager) : IDrawable
{
    ...
    public void Draw()
    {
        ImGui.BeginChild("MoodlesContent", KinkLinkStyle.ContentSize, false, KinkLinkStyle.ContentFlags);

        var width = ImGui.GetWindowWidth();
        var padding = new Vector2(ImGui.GetStyle().WindowPadding.X, 0);

        var begin = ImGui.GetCursorPosY();
        SharedUserInterfaces.ContentBox("MoodlesFromMoodles", KinkLinkStyle.PanelBackground, true, () =>
        {
        ...
        SharedUserInterfaces.ContentBox("MoodlesSend", KinkLinkStyle.PanelBackground, false, () =>
        {
