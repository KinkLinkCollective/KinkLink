    ...
    SelectionManager selectionManager) : IDrawable
{
    ...
    public void Draw()
    {
        ...
        {
            SharedUserInterfaces.ContentBox("A2", KinkLinkStyle.PanelBackground, true, () =>
            {
        ...
        SharedUserInterfaces.ContentBox("FriendsHeader", KinkLinkStyle.PanelBackground, true, () =>
        {
        ...
        SharedUserInterfaces.ContentBox("FriendsSpeakOptions", KinkLinkStyle.PanelBackground, true, () =>
        {
        ...
        SharedUserInterfaces.ContentBox("FriendsGeneralOptions", KinkLinkStyle.PanelBackground, true, () =>
        {
        ...
        SharedUserInterfaces.ContentBox("FriendsCharacterAttributesOptions", KinkLinkStyle.PanelBackground, false, () =>
        {
        ...
        /*
        SharedUserInterfaces.ContentBox("FriendsElevatedOptions", KinkLinkStyle.ElevatedBackground, false, () =>
        {
