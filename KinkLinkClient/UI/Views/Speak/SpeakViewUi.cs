    ...
    SelectionManager selectionManager) : IDrawable
{
    ...
    public void Draw()
    {
        ImGui.BeginChild("SpeakContent", KinkLinkStyle.ContentSize, false, KinkLinkStyle.ContentFlags);

        switch (selectionManager.Selected.Count)
        {
            case 0:
                SharedUserInterfaces.ContentBox("SpeakSelectMoreFriends", KinkLinkStyle.PanelBackground, true, () =>
                {
            ...
            case > 3:
                SharedUserInterfaces.ContentBox("SpeakLimitedSelection", KinkLinkStyle.PanelBackground, true, () =>
                {
        ...
        SharedUserInterfaces.ContentBox("SpeakChannel", KinkLinkStyle.PanelBackground, true, () =>
        {
        ...
        switch (controller.ChannelSelectionIndex)
        {
            case (int)ChatChannel.Linkshell or (int)ChatChannel.CrossWorldLinkshell:
                SharedUserInterfaces.ContentBox("SpeakLinkshell", KinkLinkStyle.PanelBackground, true, () =>
                {
            ...
            case (int)ChatChannel.Tell:
                SharedUserInterfaces.ContentBox("SpeakTell", KinkLinkStyle.PanelBackground, true, () =>
                {
        ...
        {
            SharedUserInterfaces.ContentBox("SpeakLackingPermissions", KinkLinkStyle.PanelBackground, true, () =>
            {
        ...
        SharedUserInterfaces.ContentBox("SpeakSend", KinkLinkStyle.PanelBackground, false, () =>
        {
