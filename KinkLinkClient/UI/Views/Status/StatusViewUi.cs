    ...
    TipService tipService) : IDrawable
{
    public void Draw()
    {
        ...
        SharedUserInterfaces.ContentBox("StatusHeader", KinkLinkStyle.PanelBackground, true, () =>
        {
        ...
        SharedUserInterfaces.ContentBox("StatusLogout", KinkLinkStyle.PanelBackground, true, () =>
        {
        ...
        SharedUserInterfaces.ContentBox("StatusButtons", KinkLinkStyle.PanelBackground, true, () =>
        {
        ...
        SharedUserInterfaces.ContentBox("OmniTool", KinkLinkStyle.PanelBackground, false, () =>
        {
    ...
    {
        SharedUserInterfaces.ContentBox("StatusLock", KinkLinkStyle.ElevatedBackground, true, () =>
        {
    ...
    {
        SharedUserInterfaces.ContentBox("StatusTransformation", KinkLinkStyle.PanelBackground, true, () =>
        {
