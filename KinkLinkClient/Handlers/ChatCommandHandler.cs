    ...
    private async void OnCommand(string command, string args)
    {
        try
        {
            ...
            switch (args)
            {
                case StopArg:
                    // Stop any spirals
                    payloads.Add(new UIForegroundPayload(KinkLinkStyle.TextColorPurple));
                    payloads.Add(new TextPayload("[KinkLink] "));
                ...
                case SafeWord:
                    ...
                    payloads.Add(new UIForegroundPayload(KinkLinkStyle.TextColorGreen));
